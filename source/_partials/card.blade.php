...
">
    ...
    <p class="text-center break-words p-2 absolute bottom-1 left-1 z-10 transition transform ease-in-out text-white group-hover:text-center group-hover:-translate-y-32"> {{ $title }}</p>
</a>
